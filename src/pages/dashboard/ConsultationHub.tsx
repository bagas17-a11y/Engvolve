...
const COACHES = [
  {
    ...
    score: "IELTS 8.5",
    bio: "Built Mumpuni to give Indonesian learners the kind of feedback he wished he'd had. Focus: Writing & Speaking strategy.",
...
export default function ConsultationHub() {
  ...
  const waMessage = useMemo(() => {
    const name = profile?.full_name?.trim() || "an Mumpuni Elite member";
    return `Hi Mumpuni team, this is ${name}. I'd like to book a 1-on-1 coaching session with ${selectedCoach.name}.`;
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Book a 1-on-1 session with your Mumpuni coach.
            </p>
          </div>
        </div>
