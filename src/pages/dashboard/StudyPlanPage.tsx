...
const POLISHING_PLAN: TierPlan = {
  ...
  weeks: [
    ...
    {
      week: 4,
      theme: "Review & Final Practice",
      focus: "Mock & Review",
      color: "green",
      rationale: "Week 4 is your consolidation week. Go back through MudahinAja and make sure you remember the key strategies and phrases taught across all four modules. Then put them into practice — do at least one question in each module and apply everything you have learned.",
      tasks: [
        {
          id: "p-w4-review-mudahinaja",
          label: "Day 1: Review MudahinAja — All 4 Modules",
          description: "Go back through MudahinAja and re-read all four module tutorials. Focus on any strategies or phrases you feel less confident with. You do not need to rush — the goal is to make sure everything you have studied over the past three weeks is fresh before your practice sessions.",
          resourcePath: "/dashboard/elite",
          resourceLabel: "Open MudahinAja",
          minutes: 40,
        },
        {
          id: "p-w4-review-phrases",
          label: "Day 2: Review the Phrases — Vocabulary Bank",
          description: "Open the Vocabulary Bank in Revision Notes and go through your three vocabulary areas: Idiomatic Expressions, Transitory Phrases & Data Descriptors, and Collocations. Try to recall the meaning of each item before reading it. If you completed the worksheets in Week 1, glance back at your answers to see which phrases felt most natural.",
          resourcePath: "/dashboard/revision-notes?topic=vocabulary-passages",
          resourceLabel: "Open Vocabulary Bank",
          minutes: 30,
        },
        {
          id: "p-w4-practice-reading",
          label: "Day 3: Module Practice — Reading",
          description: "Do a full Reading session. Apply the inference strategies from MudahinAja — locate the specific sentence the question is based on and decide whether the text confirms, contradicts, or says nothing about the claim.",
          resourcePath: "/dashboard/reading",
          resourceLabel: "Open Reading Module",
          minutes: 60,
        },
        {
          id: "p-w4-practice-listening",
          label: "Day 4: Module Practice — Listening",
          description: "Do a full Listening session. Use the pre-reading strategy before each audio section. After finishing, check whether any errors were caused by not reading the questions in advance.",
          resourcePath: "/dashboard/listening",
          resourceLabel: "Open Listening Module",
          minutes: 50,
        },
        {
          id: "p-w4-practice-speaking",
          label: "Day 5: Module Practice — Speaking",
          description: "Do a full Speaking session. In Part 3, try to use at least one idiomatic expression and one transitory phrase naturally. If a phrase does not fit the topic, do not force it.",
          resourcePath: "/dashboard/speaking",
          resourceLabel: "Open Speaking Module",
          minutes: 30,
        },
        {
          id: "p-w4-practice-writing",
          label: "Day 6: Module Practice — Writing",
          description: "Do a full Writing session. In Task 1 use at least one data descriptor upgrade. In Task 2 use at least one collocation and one transitory phrase. After AI feedback, note whether your vocabulary upgrades felt natural or forced — that distinction is Band 8.",
          resourcePath: "/dashboard/writing",
          resourceLabel: "Open Writing Module",
          minutes: 60,
        },
...
<h1>${task.label}</h1>
<div class="meta">Completed: ${date} | For review by the Mumpuni coaching team</div>
${prompts.map(p => `
