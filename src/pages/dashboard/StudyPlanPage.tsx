      ...
      tasks: [
        {
          ...
          vocabList: [
            ...
            },
            {
              ...
              workedExample: "Version 1 (detrimental): 'A diet high in processed food has a detrimental impact on children's long-term health outcomes, contributing to rising rates of childhood obesity and type-2 diabetes that impose significant costs on healthcare systems.'\n\nVersion 2 (adversely): 'Consuming excessive amounts of fast food adversely affects children's metabolic development, with consequences that frequently persist into adulthood regardless of later dietary changes.'",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Pivotal: 'Quality teacher training plays a pivotal role in educational reform — no curriculum redesign or technology investment can compensate for inadequate instructional expertise in the classroom.'\n\nParamount: 'Equity of access to early-childhood education is of paramount importance to any government serious about breaking cycles of intergenerational poverty, as the cognitive benefits of quality foundational schooling compound significantly over a child's academic lifetime.'",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Global smartphone adoption increased considerably faster than any previous consumer technology in the 2010s, rising from approximately 1.5 billion users in 2012 to over 3.5 billion by 2020 — with penetration in developing economies growing markedly throughout the latter half of the period.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "A growing body of opinion suggests that nuclear energy should be reconsidered as a central component of national clean energy strategy, particularly as newer reactor designs address many of the safety concerns that have historically defined public and political opposition to the technology.",
              examples: [
        ...
        },
        {
          ...
          vocabList: [
            ...
            },
            {
              ...
              workedExample: "Evidence suggests that social media platforms have simultaneously lowered the barrier to political participation among younger demographics and contributed to ideological echo chambers that reduce meaningful exposure to opposing perspectives — a paradox that complicates any straightforward assessment of their net democratic value.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Technology has undeniably made communication more efficient and accessible across the globe, collapsing geographical barriers that would have made real-time international exchange impossible a generation ago. This is not to say that digital communication is equivalent to face-to-face interaction in every meaningful respect — the nuance, empathy, and trust that build through physical presence remain genuinely difficult to replicate online — but that the net effect on human connectivity has been overwhelmingly positive for those with reliable access to it.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Artificial intelligence is reshaping the labour market to varying degrees depending on the cognitive complexity and predictability of the tasks involved: workers in manual, repetitive, or data-entry roles face the most acute near-term displacement, while those in positions requiring creative judgment, interpersonal skill, or non-routine problem-solving remain considerably more insulated from automation.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "It remains to be seen whether the current wave of AI-driven automation will generate the new categories of employment that previous technological revolutions have historically produced, or whether the unprecedented pace and breadth of this disruption are sufficiently different to break that historical pattern entirely — a question whose answer will define the social contract of the coming decades.",
              examples: [
          ...
          vocabList: [
            {
              ...
              workedExample: "Manufacturing constituted approximately 35% of Country A's GDP in 2010 — the largest single sector by a considerable margin — with services and agriculture each accounting for roughly half that share at around 18% and 17% respectively.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Country A's education investment, at 3.1% of GDP, was dwarfed by Country B's allocation of 8.7% — a disparity of nearly three to one that, given comparable population sizes, suggests fundamentally different policy priorities rather than differences in fiscal capacity.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "Defence expenditure exceeded in excess of $45 billion annually, dwarfing the allocation to arts and culture which, at $800 million, represented a fraction of total government spending — a ratio of approximately 56 to 1 that prompted considerable public debate about whether the balance between security investment and cultural funding reflected the nation's stated values.",
              examples: [
          ...
          vocabList: [
            {
              ...
              workedExample: "What pattern: 'What most fundamentally undermines educational equality in developing nations is not the quality of physical school infrastructure, but the widening digital divide that denies millions of students access to the online resources their wealthier counterparts take for granted.'\n\nIt is...that pattern: 'It is the widening digital divide, rather than inadequate physical schooling infrastructure, that constitutes the most significant and least-discussed barrier to educational equality across the developing world.'",
              examples: [
            ...
            },
            {
              ...
              workedExample: "(1) 'Never has the need for coordinated international climate action been more pressing — nor has the political will to deliver it at the scale required been more conspicuously absent from the governments of the world's largest emitters.'\n\n(2) 'Only by reforming both the progressive tax structure and the reach of the social safety net can governments meaningfully address the structural wealth disparities that have widened continuously over the past four decades.'",
              examples: [
          ...
          vocabList: [
            {
              ...
              workedExample: "Right, so when it comes to healthcare spending, I think most governments are caught between short-term budget pressures and what would actually be optimal for long-term population health. Well, I suppose the honest answer is that no government spends enough — demand for healthcare consistently outpaces supply, particularly as populations age and chronic disease rates rise. The data from the OECD consistently shows that countries with higher public health investment have better outcomes across almost every metric. That said, the efficiency of how existing budgets are allocated is arguably as important as the total amount spent — several countries achieve excellent outcomes on relatively modest per-capita expenditure by prioritising primary care over acute intervention.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "What I find most counterintuitive about how technology has changed communication is not that it has made us more connected — that's obvious — but that it has simultaneously made many people feel significantly more isolated. Research consistently shows that people with the highest social media usage often report the lowest levels of genuine social satisfaction, which suggests that frequency of contact and quality of connection are very different things. I'd argue that the reason is fairly straightforward: digital communication optimises for reach and speed, not depth. That said, for people who are geographically isolated — whether by choice or circumstance — technology has genuinely transformed their access to community in ways that are wholly positive.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "I think on balance a city childhood offers considerably more in terms of educational opportunity, cultural exposure, and social diversity — all of which contribute to a more adaptable and resilient adult. The range of schools, extracurricular activities, and peer groups available in a major city is simply not replicable in most rural settings, and I think that diversity of experience is genuinely formative. That said, the pace and density of city life come at a real developmental cost: children in urban environments typically get far less unstructured outdoor play, which the developmental psychology literature consistently links to creativity, emotional regulation, and risk tolerance. So my view is that it depends enormously on the specific city and specific countryside in question — a well-resourced rural community might actually outperform a deprived urban neighbourhood on most of the dimensions that matter.",
              examples: [
            ...
            },
            {
              ...
              workedExample: "I'd argue that framing this as a binary choice between economic development and environmental protection is itself the fundamental problem — the most compelling economic argument for environmental protection is that long-term development is simply impossible on a degraded resource base. The idea that we're choosing between growth today and sustainability tomorrow assumes they're mutually exclusive, when the most credible economic modelling suggests they're increasingly the same thing. I'm fairly convinced that countries which invest early in clean infrastructure and circular economy models will have a significant competitive advantage within two decades, as both input costs and regulatory environments shift decisively in that direction. That said, I do understand why governments presiding over acute poverty find it politically difficult to ask citizens to accept short-term hardship for long-term sustainability gains — the distributional politics of that trade-off are genuinely hard, and I think dismissing that difficulty is intellectually dishonest.",
              examples: [
          ...
          {item.practice && (
            <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 space-y-3">
              ...
              {!revealed.has(idx) ? (
                ...
                <div className="rounded-lg border border-amber-400/30 bg-amber-400/5 p-3.5 space-y-1.5">
                  <p className="text-[10px] font-bold text-amber-300 uppercase tracking-widest">Worked example</p>
                  <p className="text-sm text-foreground/85 leading-relaxed whitespace-pre-wrap">{item.workedExample}</p>
                </div>
              ) : null}
            </div>
          )}
