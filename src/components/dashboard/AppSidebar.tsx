...
export function AppSidebar() {
  ...
  return <Sidebar collapsible="icon" className="border-r border-border/30">
      {/* Header */}
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && <div className="overflow-hidden">
              <h1 className="text-sm font-semibold truncate">IELTSinAja</h1>
      ...
      <SidebarContent>
        ...
        {isAdmin && <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton onClick={() => navigate("/admin")} isActive={location.pathname.startsWith("/admin")} tooltip="Admin Portal">
      ...
      <SidebarFooter className="p-4 border-t border-border/30">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && <Button variant="ghost" size="icon" onClick={handleSignOut} className="flex-shrink-0">
